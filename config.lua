    ...
    [5] = {
        ...
        items = {
            ...
            },
            {
                ...
                icon = 'eye',
                type = 'client',
                event = 'rsettings:visualsettings',
                shouldClose = true,
            },
        }
    }
